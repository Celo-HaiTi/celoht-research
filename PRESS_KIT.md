...
## Boilerplate (for articles, press releases, partner pages)
...
- **Website:** celoht.com
- **Documentation:** github.com/Celo-HaiTi/celoht-research
- **Contact:** contact@celoht.org / celoht3@gmail.com

## Logo & Visual Assets

All logo files are available in [`logos/`](./logos) — SVG preferred for print and digital use. See [LOGO_GUIDELINES.md](./LOGO_GUIDELINES.md) before publishing.

## Approved Quotes

> "CeloHT was built on a simple idea: financial inclusion only works if people understand and trust the tools they're given. That means education first, real local support, and complete transparency about what we are — and just as importantly, what we're not." — Johnny Dubic, Founder

*(Additional spokesperson quotes should be approved by community maintainers before publication — see [CONTRIBUTING.md](./CONTRIBUTING.md).)*
...
- CeloHT supports wallet connectivity through Valora, MiniPay, and WalletConnect. CeloHT is wallet-agnostic and does not operate or custody user wallets. Wallets are used by users to connect and authorize transactions through the CeloHT dApp.
...
contact@celoht.org — please allow 3–5 business days for press inquiries.
