...
Community nurseries build local, durable capacity to supply planting programs — reducing dependence on external sapling sourcing and creating an ongoing local role tied to environmental stewardship.

## Establishing a Nursery

### Site Requirements
- Reliable water access (critical — nursery failure is most commonly a water-access failure)
- Partial shade structure (constructed locally, low-cost materials preferred)
- Secure from livestock/foot traffic
...
| Task | Frequency |
|---|---|
| Watering | Daily (adjusted for rainfall) |
| Pest/disease check | Weekly |
| Growth measurement & thinning | Bi-weekly |
| Record update | Weekly |

## Nursery Records

Each nursery maintains a log of: species in propagation, quantity by growth stage (seedling/juvenile/ready-to-plant), estimated ready-for-planting date, and any loss events with cause noted (pest, water stress, disease) — loss data is not hidden, it directly informs species and site selection improvements over time.
...
As a region's planting program grows, a single nursery's capacity is assessed against upcoming planting event needs (see [planting-methodology.md](./planting-methodology.md)); additional nurseries are established using the same process above, coordinated by the Reforestation Working Group to avoid oversupply of any single species relative to planned sites.
