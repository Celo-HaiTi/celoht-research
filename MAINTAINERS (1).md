...
- Triage issues using the standard response templates
- Participate in governance decisions per [GOVERNANCE.md](./GOVERNANCE.md)
- Uphold the [Code of Conduct](./CODE_OF_CONDUCT.md) in every interaction

## Becoming a Maintainer

There's no fixed application form. Council nomination follows sustained, high-quality contribution over time — start with an issue tagged `good-first-issue`, keep contributing, and engage constructively in reviews and discussions. See [CONTRIBUTING.md](./CONTRIBUTING.md).
...
Maintainers can step back from active responsibilities at any time. CeloHT is volunteer-heavy, and stepping back doesn't erase past contribution recognition.

## CODEOWNERS

This organization uses [`CODEOWNERS`](./CODEOWNERS) to route review requests automatically. Individual repositories may define more specific `CODEOWNERS` files that take precedence.
