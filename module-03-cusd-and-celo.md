...
## Audience
Individuals who have completed Module 2. Also relevant standalone for entrepreneurs and Agent Network candidates.
...
**Practical skill:** Walk through a real (testnet) transaction screen together — what the amount means, what the small gas fee (in CELO) means, and how to confirm a transaction went through. Directly prepares participants for [Module 4](./module-04-wallet-safety.md) and real use of the [dApp](../DAPP.md).
