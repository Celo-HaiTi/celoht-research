...
- Local blockchain interactions: use the Celo Sepolia testnet (`NEXT_PUBLIC_CELO_NETWORK=celo-sepolia`) — never test against mainnet with real funds
...
const client = new CeloHT({ network: 'celo-sepolia' });
