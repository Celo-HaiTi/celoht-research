...
## Duration
Approx. 90 minutes (in-person workshop) or 6 × 15-minute micro-lessons (app-based).

## Learning Objectives

By the end of this module, a participant should be able to:
1. Explain the difference between saving and spending, and why both matter
2. Identify at least three common budgeting mistakes and how to avoid them
3. Understand what a transaction fee is and why it exists
4. Explain, in their own words, the concept of "value" in a digital payment
...
**Key concept:** A budget is simply a plan for money coming in versus money going out.

**Simple framework taught:**
- Income (what comes in)
- Essential spending (what you must pay — food, housing, transport)
- Savings (what you set aside first, not last)
- Flexible spending (what's left)

**Common mistake #1:** Treating savings as "whatever is left over" instead of planning for it first.
**Common mistake #2:** Not tracking small, frequent purchases that add up.
**Common mistake #3:** No separation between business and personal spending for entrepreneurs — connects to [Module 6](./module-06-responsible-digital-finance.md) and small-business use cases.
...
[Module 2: Introduction to Web3 & Blockchain →](./module-02-web3-and-blockchain.md)
