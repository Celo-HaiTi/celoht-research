...
- Email: **contact@celoht.org** or **celoht3@gmail.com**
...
This repository is documentation and static assets; there is no versioned "patching" model. The `main` branch always reflects the current, correct brand standard. Older tagged releases (see [CHANGELOG.md](./CHANGELOG.md)) are kept for historical reference only and should not be treated as current guidance.
